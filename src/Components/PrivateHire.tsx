...
export const PrivateHire = () => {
    return (
        <div className="bg-cover bg-no-repeat relative z-10 flex justify-center items-center border-t-red-primary border-t-[1px] border-b-red-primary border-b-[1px]">
